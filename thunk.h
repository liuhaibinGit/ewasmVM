...
#define THUNK_OUT_0(M,FN,R) { \
    TH_RES_##R ((TH_C_##R (*)(Module *))FN->func_ptr)(M); \
    M->sp += 0 + TH_RCNT_##R; TH_OUT_RET_##R(M); \
}
#define THUNK_OUT_1(M,FN,R,A) { \
    TH_RES_##R ((TH_C_##R (*)(TH_C_##A, Module *))FN->func_ptr)(TH_SP(M,+0,A), M); \
    M->sp += -1 + TH_RCNT_##R; TH_OUT_RET_##R(M); \
}
#define THUNK_OUT_2(M,FN,R,A,B) { \
    TH_RES_##R ((TH_C_##R (*)(TH_C_##A,TH_C_##B, Module *))FN->func_ptr)(TH_SP(M,-1,A),TH_SP(M,+0,B),M); \
    M->sp += -2 + TH_RCNT_##R; TH_OUT_RET_##R(M); \
}
#define THUNK_OUT_3(M,FN,R,A,B,C) { \
    TH_RES_##R ((TH_C_##R (*)(TH_C_##A,TH_C_##B,TH_C_##C, Module *))FN->func_ptr)(TH_SP(M,-2,A),TH_SP(M,-1,B),TH_SP(M,+0,C),M); \
    M->sp += -3 + TH_RCNT_##R; TH_OUT_RET_##R(M); \
}
#define THUNK_OUT_4(M,FN,R,A,B,C,D) { \
    TH_RES_##R ((TH_C_##R (*)(TH_C_##A,TH_C_##B,TH_C_##C,TH_C_##D,  Module *))FN->func_ptr)(TH_SP(M,-3,A),TH_SP(M,-2,B),TH_SP(M,-1,C),TH_SP(M,+0,D),M); \
    M->sp += -4 + TH_RCNT_##R; TH_OUT_RET_##R(M); \
}
#define THUNK_OUT_5(M,FN,R,A,B,C,D,E) { \
    TH_RES_##R ((TH_C_##R (*)(TH_C_##A,TH_C_##B,TH_C_##C,TH_C_##D,TH_C_##E, Module *))FN->func_ptr)(TH_SP(M,-4,A),TH_SP(M,-3,B),TH_SP(M,-2,C),TH_SP(M,-1,D),TH_SP(M,+0,E),M); \
    M->sp += -5 + TH_RCNT_##R; TH_OUT_RET_##R(M); \
}
#define THUNK_OUT_6(M,FN,R,A,B,C,D,E,F) { \
    TH_RES_##R ((TH_C_##R (*)(TH_C_##A,TH_C_##B,TH_C_##C,TH_C_##D,TH_C_##E,TH_C_##F, Module *))FN->func_ptr)(TH_SP(M,-5,A),TH_SP(M,-4,B),TH_SP(M,-3,C),TH_SP(M,-2,D),TH_SP(M,-1,E),TH_SP(M,+0,F),M); \
    M->sp += -6 + TH_RCNT_##R; TH_OUT_RET_##R(M); \
}
#define THUNK_OUT_9(M,FN,R,A,B,C,D,E,F,G,H,I) { \
    TH_RES_##R ((TH_C_##R (*)(TH_C_##A,TH_C_##B,TH_C_##C,TH_C_##D,TH_C_##E,TH_C_##F,TH_C_##G,TH_C_##H,TH_C_##I, Module *))FN->func_ptr)(TH_SP(M,-8,A),TH_SP(M,-7,B),TH_SP(M,-6,C),TH_SP(M,-5,D),TH_SP(M,-4,E),TH_SP(M,-3,F),TH_SP(M,-2,G),TH_SP(M,-1,H),TH_SP(M,+0,I),M); \
