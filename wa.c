...
bool interpret(Module *m) {
    ...
    while (m->pc < m->byte_count) {
		...
		case 0x69:
            ...
            switch (opcode) {
            case 0x67: c = a==0 ? 32 : i32_clz(a); break; // i32.clz
            case 0x68: c = a==0 ? 32 : i32_ctz(a); break; // i32.ctz
            case 0x69: c = i32_popcnt(a); break;        // i32.popcnt
            }
            stack[m->sp].value.uint32 = c;
            continue;
		...
		case 0x7b:
            ...
            switch (opcode) {
            case 0x79: f = d==0 ? 64 : i64_clz(d); break; // i64.clz
            case 0x7a: f = d==0 ? 64 : i64_ctz(d); break; // i64.ctz
            case 0x7b: f = i64_popcnt(d); break;        // i64.popcnt
            }
